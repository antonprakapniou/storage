...
/// <summary>
/// CRUD operations for <see cref="TopicDto"/>
/// </summary>
[Route("topic")]
[ApiController]
...
public class TopicController : ControllerBase
{
    ...
    /// <response code="404">If <see cref="TopicDto"/> collection not found.</response>
    ...
    /// <response code="200">Returns the <see cref="TopicDto"/> collection</response>
    /// <response code="404">If <see cref="TopicDto"/> instance not found.</response>
    /// <response code="500">If the generic error in the server.</response>
    [HttpGet("{id}")]
    ...
    /// <response code="400">If <see cref="TopicDto"/> instance creating is failed </response>
    ...
    /// <summary>Modify an instance of <see cref="TopicDto"/> by <paramref name="id"/> identifier.</summary>
    /// <param name="id"></param>
    /// <param name="dto"></param>
    /// <returns>Modified <see cref="TopicDto"/> instance.</returns>
    /// <response code="202">Returns the modified <see cref="TopicDto"/> instance.</response>
    /// <response code="400">If <see cref="TopicDto"/> instance modifying is failed </response>
    /// <response code="422">If <see cref="TopicDto"/> instance is not valid.</response>
    /// <response code="500">If the generic error in the server.</response>
    [HttpPut("{id}")]
    ...
    /// <summary>Remove an instance of <see cref="TopicDto"/> by <paramref name="id"/> identifier.</summary>
    /// <param name="id"></param>
    /// <response code="204">IF <see cref="TopicDto"/> instance removing is successfull.</response>
    /// <response code="400">If <see cref="TopicDto"/> instance removing is failed </response>
    /// <response code="404">If <see cref="TopicDto"/> instance not found.</response>
    /// <response code="500">If the generic error in the server.</response>
    [HttpDelete("{id}")]
